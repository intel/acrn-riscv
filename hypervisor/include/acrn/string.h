#ifndef __ACRN_STRING_H__
#define __ACRN_STRING_H__

#include <acrn/types.h>	/* for size_t */
 ...
 */
#define strcpy  __acrn_has_no_strcpy__
#define strcat  __acrn_has_no_strcat__
#define strncpy __acrn_has_no_strncpy__
#define strncat __acrn_has_no_strncat__
