#ifndef _ACRN_PARAM_H
#define _ACRN_PARAM_H

#include <acrn/hypfs.h>
#include <acrn/init.h>
#include <acrn/lib.h>
#include <types.h>
...
#define custom_runtime_only_param(nam, variable, initfunc) \
    __paramfs __parfs_##variable = \
        { .hypfs.e.type = ACRN_HYPFS_TYPE_STRING, \
          .hypfs.e.encoding = ACRN_HYPFS_ENC_PLAIN, \
          .hypfs.e.name = (nam), \
...
#define boolean_runtime_only_param(nam, variable) \
    __paramfs __parfs_##variable = \
        { .hypfs.e.type = ACRN_HYPFS_TYPE_BOOL, \
          .hypfs.e.encoding = ACRN_HYPFS_ENC_PLAIN, \
          .hypfs.e.name = (nam), \
...
#define integer_runtime_only_param(nam, variable) \
    __paramfs __parfs_##variable = \
        { .hypfs.e.type = ACRN_HYPFS_TYPE_UINT, \
          .hypfs.e.encoding = ACRN_HYPFS_ENC_PLAIN, \
          .hypfs.e.name = (nam), \
          .hypfs.e.size = sizeof(variable), \
          .hypfs.e.max_size = sizeof(variable), \
                                   ...
                                   const char *s, const char *e)
{
    ...
    printk(ACRNLOG_INFO "CONFIG_%s disabled - ignoring '%s=%*s' setting\n",
           cfg, param, len, s);
}
