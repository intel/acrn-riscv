...
#define DEL_MODE_SGI		(3U)
#define DEL_MODE_SWI		(4U)
...
#ifdef CONFIG_ARM
DECLARE_PER_CPU(struct thread_object, idle);
...
void arch_switch_to(struct thread_object *prev, struct thread_object *next);
